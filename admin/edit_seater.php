...
<body>
	...
	<div class = "container-fluid">	
		<ul class = "nav nav-pills">
			...
			<li><a href = "reserve.php">Requests</a></li>
	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Sitter</div>
				<br />
				<div class = "col-md-4">
					<?php
						$query = $conn->query("SELECT * FROM `seatersdetails` WHERE `seaterid` = '$_REQUEST[seaterid]'") or die(mysqli_error());
						$fetch = $query->fetch_array();
					?>
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							<label>Seaters details </label>
						...
						<div class = "form-group">
							<label>Charge </label>
							<input type = "text"  value = "<?php echo $fetch['charge']?>" class = "form-control" name = "charge" />
						</div>
						<div class = "form-group">
							<label>email </label>
							<input type = "text"  value = "<?php echo $fetch['email']?>" class = "form-control" name = "email" />
						</div>
						<div class = "form-group">
							<label>Photo </label>
						...
						<br />
						<div class = "form-group">
							<button name = "edit_seater" class = "btn btn-warning form-control"><i class = "glyphicon glyphicon-edit"></i> Save Changes</button>
						</div>
					</form>
					<?php require_once 'edit_query_seater.php'?>
				</div>
			</div>
		</div>
	</div>
