	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			<?php
				...
				$f_p = $q_p->fetch_array();
			   $q_ci = $conn->query("SELECT COUNT(*) as total FROM `transaction` WHERE `status` = 'Confirm'") or die(mysqli_error());
			...
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `parent`  WHERE `status` = 'Pending'") or die(mysqli_error()); 
